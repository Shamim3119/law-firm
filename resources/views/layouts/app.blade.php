...
<html lang="en">
  ...
  <head>
    ...
    <meta name="title" content="Law Firm Application" />
    <meta name="author" content="ColorlibHQ" />
    
    <meta
      name="description"
      content="Law Firm Application is a Free Bootstrap 5 Admin Dashboard, 30 example pages using Vanilla JS. Fully accessible with WCAG 2.1 AA compliance."
    />
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item">{{ $title ?? 'Home' }}</li>
                  <li class="breadcrumb-item active" aria-current="page">{{ $sub_title ?? 'Dashboard' }}</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
