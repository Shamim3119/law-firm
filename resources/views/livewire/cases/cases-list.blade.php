<div> <!-- single root -->
    ...
    <a href="{{ route('cases.create') }}" class="btn btn-sm btn-primary mb-3">New Cases</a>
    <br>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $case->court_no }} / {{ $case->court_name }}</td>
                        <td> 
                            {{ \Carbon\Carbon::parse($case->hearing_date)->format('d M, Y') }}   
                            {{ \Carbon\Carbon::parse($case->hearing_time)->format('g:i A') }}
                        </td>
